...
const PopUpItem = ({ type, onClose, onCreate }) => {
    ...
    const [image, setImage] = useState(""); // Добавляем состояние для изображения

    const handleCreate = () => {
        if ((type === "project" && projectName.trim() && projectDetails.trim()) ||
            ...
            const newItem = {
                ...
                type,
                image: type === "project" ? image : null, // Добавляем картинку только для проектов
            };
